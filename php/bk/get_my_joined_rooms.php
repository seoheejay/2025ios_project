...
SELECT
    ...
    (
        SELECT COUNT(*)
        FROM ykt.meal_mate_participant p2
        WHERE p2.room_id = r.room_id
    ) AS current_participants,
    CASE 
        WHEN r.creator_id = ? THEN 1
        ELSE 0 
    END AS isMine
FROM ykt.meal_mate_participant p
JOIN ykt.meal_mate_room r ON p.room_id = r.room_id
